...
public class Bishop extends ChessPiece {
	...
	public Bishop(int x, int y,String color) {
		...
		if (color.equals("Black")){
			this.image = new ImageIcon(System.getProperty("user.dir") + "/images/BishopBlack.png");
			this.pieceColor = "Black";
		}
		if (color.equals("White")){
	    	this.image = new ImageIcon(System.getProperty("user.dir") + "/images/BishopWhite.png");
