...
public class Rook extends ChessPiece {
	...
	public Rook(int x, int y,String color) {
		...
		if (color.equals("Black")){
			this.image = new ImageIcon(System.getProperty("user.dir") + "/images/RookBlack.png");
			this.pieceColor = "Black";
		}
		if (color.equals("White")){
	    	this.image = new ImageIcon(System.getProperty("user.dir") + "/images/RookWhite.png");
		...
		//ChessBoard chessBoard = ChessBoard.getInstance();
			...
			//if ( this.isWhite() || this.isBlack()){
				...
				for ( int i=0;i<8;i++){
					...
					if (desPosY == curPosY && desPosX == curPosX-i /*|| desPosY == curPosY && desPosX == curPosX+i*/ ){
